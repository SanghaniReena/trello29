...
app.post("/:idcards/cardsdetail", (req, res) => {
    ...
    mysqlConnection.query("UPDATE cards SET (cDesc,cComment,cWatch) VALUES ('" + req.body.cDesc + "','" + req.body.cComment + "'," + req.body.cWatch + "," + req.body.idteams + "," + req.body.iduser + ") WHERE idcards=?",[req.params.idcards] ,(err, rows) => {
        if (!err) {
